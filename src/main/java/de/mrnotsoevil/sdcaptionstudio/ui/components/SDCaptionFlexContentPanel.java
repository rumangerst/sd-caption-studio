 ...
 */
public class SDCaptionFlexContentPanel extends JPanel {
    ...
    private AutoResizeSplitPane.Ratio sidebarRatio = new AutoResizeSplitPane.DynamicSidebarRatio(450, false);

    public SDCaptionFlexContentPanel() {
        this(NONE);
    }

    public SDCaptionFlexContentPanel(int flags) {
    ...
    public void rebuildLayout() {
        ...
        if (sideBar != null && sideBarVisible) {
            centerPanel = new AutoResizeSplitPane(AutoResizeSplitPane.LEFT_RIGHT, contentPanel, sideBar, sidebarRatio);
        } else {
    ...
    public AutoResizeSplitPane.Ratio getSidebarRatio() {
        return sidebarRatio;
    }

    public void setSidebarRatio(AutoResizeSplitPane.Ratio sidebarRatio) {
