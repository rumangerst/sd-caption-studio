...
public class SDCaptionedCompactImageListCellRenderer extends JPanel implements ListCellRenderer<SDCaptionedImage> {
    ...
    public SDCaptionedCompactImageListCellRenderer(SDCaptionProject project) {
